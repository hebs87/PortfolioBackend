...
class PersonalDetailsViewSet(viewsets.ModelViewSet):
    """
    A viewset to return PersonalDetails model objects to the frontend
...
class ProfessionalSkillsViewSet(viewsets.ModelViewSet):
    """
    A viewset to return ProfessionalSkills model objects to the frontend
    """
...
class WorkExperienceViewSet(viewsets.ModelViewSet):
    """
    A viewset to return WorkExperience model objects to the frontend
...
class EducationViewSet(viewsets.ModelViewSet):
    """
    A viewset to return Education model objects to the frontend
    Order by newest to oldest date_from
    """
